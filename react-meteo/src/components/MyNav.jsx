...
const MyNav = () => {
  ...
  return (
    <Navbar bg="dark" expand="lg" variant="dark" className="justify-content-between">
     <Navbar.Brand href="#" className="d-flex align-items-center mr-5 ml-5" onClick={() => window.location.reload()}>
  <img
    src={logo}
    width="80"
    height="80"
  ...
  <span className="h4">Wild Weather</span>
      ...
      <Form inline="true" className="d-flex justify-content-center mx-2" onSubmit={handleSearch}>
        <FormControl
          type="text"
        ...
        />
        <Button variant="primary" className="mx-2" type="submit"> {/* Aggiunto type="submit" qui */}
          Search
        </Button>
      </Form>
    </Navbar>
